...
class PasswordResetsTest < ActionDispatch::IntegrationTest
  ...
  test "password resets" do
    ...
    patch password_reset_path(user.reset_token), params: { email: user.email, user: { password: "skeleton", password_confirmation: "skeleton" } }
    assert is_logged_in? # because invitations are present??
    assert_not flash.empty?
